...
- Signer provenance: doc 19, "THE RELIQUARY WARDENS", SUPERSEDED note (lines 156-164), already changes the Signer into the Pale Queen's role. [NOTE 2026-09-14: superseded twice since this audit: the Signer is the WITCH's role (doc 36/44 reconciliation); the PALE QUEEN is the separate neutral underworld unifier.] Doc 37's THE WARDEN'S DOUBLE LEDGER (lines 407-412) refers to that mask consistently. Old Signer passages in docs 20-21 were not counted as new doc 37 contradictions.
